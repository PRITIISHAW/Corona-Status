...
btn2=Button(f1,text="Developer",bg='slategrey',command=lambda:swap(f5))
btn2.place(x=820, y=420,width=150,height=30)

btn2=Button(f1,text="Live Tracker",bg='slategrey',command=lambda:swap(f4))
...
btn2.place(x=820, y=510,width=150,height=30)
#=============ItemsInFrame4================================================


label3=Label(f5,text="Developers Page",font=("arial",20,"bold"),bg="slategrey",fg="black",relief=SUNKEN)
label3.pack(side=TOP,fill=X)
label3=Label(f5,text="Project by Priti Shaw",font=("arial",12,"bold"),bg="slategrey",fg="black",relief=SUNKEN)
label3.pack(side=BOTTOM,fill=X)
label3=Label(f5,text="                    Help us uncover and predict the corona spread in your area.                    ",font=("arial",12,"bold"),bg="blue",fg="black",relief=SUNKEN)
label3.place(x=200,y=130)
label3=Label(f5,text="Regardeless if you are healthy or not, please take the survey.",font=("arial",12,"bold"),bg="blue",fg="black",relief=SUNKEN)
label3.place(x=260,y=160)
label3=Label(f5,text="For any Information Please Email at:      ",font=("arial",12,"bold"),bg="slategrey",fg="black",relief=SUNKEN)
label3.place(x=10,y=280)
label3=Label(f5,text="pd3459@srmist.edu.in",font=("arial",12,"bold"),bg="slategrey",fg="black",relief=SUNKEN)
label3.place(x=10,y=310)
label3=Label(f5,text="                      Thank You!                     ",font=("arial",12,"bold"),bg="blue",fg="black",relief=SUNKEN)
...
backf3.place(x=3, y=40,width=60,height=30)
backf3=Button(f5,text="Back	",bg='red',fg='white',command=lambda:swap(f1))
backf3.place(x=3, y=40,width=60,height=30)

#=====================ItemsInFrame3==========================================
#To retrieve live data fron website
...
# parsing html and extracting data-WEB Scrapping
...
label5=Label(f4,text="Corona Data Tracker-India",font=("arial",20,"bold"),bg="slategrey",fg="black",relief=SUNKEN)
label5.pack(side=TOP,fill=X)
mainlabel5=Label(f4, text=get_corona_detail_of_india(), font=("arial",20,"bold"), bg='blue')
mainlabel5.place(x=350,y=250)
label5=Button(f4, text="REFRESH", font=("arial",20,"bold"), relief='solid', command=refresh,bg='green')
label5.place(x=450,y=450)
